                              ...
                              <ul>
                                 ...
                                 <li class="has-subMenu-left">
                                    ...
                                    <ul class="subMenu">
                                       ...
                                       <li>
                                          <a href="create.html" class="active">Create
                                             Project</a>
                                       </li>
                                    </ul>
                                 </li>
                  ...
                  <div class="project-progree-breadcrumb">
                     ...
                     <div class="breadcrumb-main user-member justify-content-sm-between createModal">
                        ...
                        <div class="action-btn">
                           <a href="#" class="btn px-15 btn-primary" data-bs-toggle="modal" data-bs-target="#new-member2">
                              <i class="las la-plus fs-16"></i>create projects</a>

                           <!-- Modal -->
                           <div class="modal fade new-member new-member__2" id="new-member2" role="dialog" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
               ...
               <div class="col-lg-12">
                  <div class="project-top-wrapper project-top-progress d-flex justify-content-between flex-wrap">
                     <div class="project-top-left d-flex flex-wrap justify-content-lg-between justify-content-center">
                        <div class="project-tap global-shadow order-lg-1 order-2 ms-xl-0 me-xl-20 ms-md-20">
                        ...
                        <div class="project-search project-search--height global-shadow mb-lg-0 mb-20 order-lg-2 order-1">
