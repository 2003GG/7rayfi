...
<head>
   ...
   <link rel="stylesheet" href="{{asset('css/assets/vendor_assets/css/bootstrap/bootstrap.css')}}">

   <link rel="stylesheet" href="{{asset( 'css/assets/vendor_assets/css/daterangepicker.css')}}">

   <link rel="stylesheet" href="{{ asset('css/assets/vendor_assets/css/fontawesome.css') }}">

   <link rel="stylesheet" href="{{ asset('css/assets/vendor_assets/css/footable.standalone.min.css') }}">

   <link rel="stylesheet" href="{{ asset('css/assets/vendor_assets/css/fullcalendar@5.2.0.css') }}">

   <link rel="stylesheet" href="{{ asset('css/assets/vendor_assets/css/jquery-jvectormap-2.0.5.css') }}">

   <link rel="stylesheet" href="{{ asset('css/assets/vendor_assets/css/jquery.mCustomScrollbar.min.css') }}">

   <link rel="stylesheet" href="{{ asset('css/assets/vendor_assets/css/leaflet.css') }}">

   <link rel="stylesheet" href="{{ asset('css/assets/vendor_assets/css/line-awesome.min.css') }}">

   <link rel="stylesheet" href="{{ asset('css/assets/vendor_assets/css/magnific-popup.css') }}">

   <link rel="stylesheet" href="{{ asset('css/assets/vendor_assets/css/MarkerCluster.css') }}">

   <link rel="stylesheet" href="{{ asset('css/assets/vendor_assets/css/MarkerCluster.Default.css') }}">

   <link rel="stylesheet" href="{{ asset('css/assets/vendor_assets/css/select2.min.css') }}">

   <link rel="stylesheet" href="{{ asset('css/assets/vendor_assets/css/slick.css') }}">

   <link rel="stylesheet" href="{{ asset('css/assets/vendor_assets/css/star-rating-svg.css') }}">

   <link rel="stylesheet" href="{{ asset('css/assets/vendor_assets/css/trumbowyg.min.css') }}">

   <link rel="stylesheet" href="{{ asset('css/assets/vendor_assets/css/wickedpicker.min.css') }}">

   <link rel="stylesheet" href="style.css">

   <!-- endinject -->

   <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('css/img/favicon.png') }}">
                              ...
                              <ul>
                                 <li class="has-subMenu-left">
                                    ...
                                    <ul class="subMenu">
                                       ...
                                       <li>
                                          <a href="read-email.html" class="active">Read
                                             Email</a>
                                       </li>
                                    </ul>
                                 </li>
                        ...
                        <div class="breadcrumb-main">
                           ...
                           <div class="breadcrumb-action justify-content-center flex-wrap">
                              <nav aria-label="breadcrumb">
                                 <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="uil uil-estate"></i>Emaill</a></li>
                              ...
                              <div class="card">
                                 ...
                                 <div class="card-body">
                                    <div class="d-flex align-content-center content-center px-15">
                                       <a href="#" class="btn-compose btn btn-md btn-primary btn-shadow-primary" data-trigger="compose"> <img src="img/svg/plus.svg" alt="plus" class="svg"> Compose</a>
                                    </div>
                                    <ul class="mail-list">
                                       <li><a class="active" href="#"><img class="svg" src="img/svg/inbox.svg" alt="inbox">Inbox <span class="badge badge-primary badge-transparent">5</span></a></li>
                                       <li><a href="#"><img src="img/svg/star.svg" alt="star" class="svg">Started</a></li>
                                       <li><a href="#"><img class="svg" src="img/svg/send.svg" alt="send">Send</a></li>
                                       <li><a href="#"><img class="svg edit" src="img/svg/edit.svg" alt="edit">Draft<span class="badge badge-primary badge-transparent">12</span></a></li>
                                       <li><a href="#"><img src="img/svg/alert-octagon.svg" alt="alert-octagon" class="svg">Spam</a></li>
                                       <li><a href="#"><img class="svg" src="img/svg/trash-2.svg" alt="trash">Trash</a></li>
                                    </ul>
                                    <span class="mail-list-title mt-35">Label</span>
                                    <ul class="mail-list mt-0">
                                       <li><a href="#"><img class="svg" src="img/svg/list.svg" alt="list">Personal</a></li>
                                       <li><a href="#"><img class="svg" src="img/svg/list.svg" alt="list">Social</a></li>
                                       <li><a href="#"><img class="svg" src="img/svg/list.svg" alt="list">Promotion</a></li>
                                    </ul>
                                    <div class="btn-add-label" data-trigger="label">
                                       <span class="cursor-true"><img src="img/svg/plus.svg" alt="plus" class="svg">Add New Label</span>
                                          ...
                                          <ul class="mailbox-top__actions d-flex align-items-center">
                                             ...
                                             <li>
                                                <a class="icon-action active" href="" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Archive">
                                                   <img class="svg nav-icon" src="img/svg/archive.svg" alt="archive">
                                                </a>
                                             </li>

                                             <li>
                                                <a class="icon-action" href="" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Info">
                                                   <img class="svg nav-icon" src="img/svg/alert-octagon.svg" alt="alert-octagon">
                                                </a>
                                             </li>
                                             <li>
                                             ...
                                             <li>
                                                <a class="icon-action" href="" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Read">
                                                   <img class="svg" src="img/svg/book-open.svg" alt="">
                                                </a>
                                             </li>
                                             <li>
                                                <a class="icon-action" href="" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Folder">
                                                   <img src="img/svg/folder.svg" alt="folder" class="svg">
                                                </a>
                                             </li>
                                          </ul>
                                    ...
                                    <div class="mail-read-content">
                                             ...
                                             <div class="mail-details__action d-flex">
                                                <a href="#" class="icon-action">
                                                   <div class="double-icon d-flex flex-column">
                                                      <img src="img/svg/chevron-up.svg" alt="sliders" class="svg">
                                                   </div>
                                                </a>
                                                <a href="#" class="icon-action">
                                                   <img src="img/svg/printer.svg" alt="printer" class="svg">
                                                </a>
                                             </div>
                                          </div>
                                          <div class="mail-details__content mdc media">
                                             <div class="mdc__left">
                                                <img src="img/author/3.jpg" alt="mail author">
                                             </div>
                                             <div class="mdc__right media-body">
                                                <div class="mdc__head d-flex justify-content-between">
                                                   <div class="mdc__author media">
                                                      <div class="author-info">
                                                         ...
                                                         <a class="mail-info-btn">To me
                                                            <img class="svg" src="img/svg/chevron-down.svg" alt="chevron-down">
                                                            <ul class="mail-info">
                                                               <li>
                                                   ...
                                                   <div class="mdc__excerpt">
                                                      <img class="svg" src="img/svg/paperclip.svg" alt="paperclip">
                                                      <span class="date-meta">Jan 2, 2020, 5:22 PM</span>
                                                      <a href="#">
                                                         <img src="img/svg/star.svg" alt="star" class="svg">
                                                      </a>
                                                      <a href="#">
                                                         <img src="img/svg/corner-up-left.svg" alt="corner-up-left" class="svg">
                                                      </a>
                                                ...
                                                <div class="mdc__footer">
                                                   <div class="mail-attatched d-flex">
                                                      <div class="mail-attatched__item">
                                                         <figure class="mb-0">
                                                            <div class="mail-attatched__image mb-3">
                                                               <img src="img/mail/1.png" alt="attatched Image">
                                                               <div class="mail-attatched__hover">
                                                                  <a href="#" class="btn-mail">
                                                                     <img src="img/svg/download.svg" alt="download" class="svg"></a>
                                                                  <a href="#" class="btn-mail">
                                                                     <img class="svg" src="img/svg/share-2.svg" alt="share-2"></a>
                                                               </div>
                                                            </div>
                                                            <figcaption>
                                                      ...
                                                      <div class="mail-attatched__item">
                                                         <figure class="mb-0">
                                                            <div class="mail-attatched__image mb-3">
                                                               <img src="img/mail/2.png" alt="attatched Image">
                                                               <div class="mail-attatched__hover">
                                                                  <a href="#" class="btn-mail">
                                                                     <img src="img/svg/download.svg" alt="download" class="svg"></a>
                                                                  <a href="#" class="btn-mail">
                                                      ...
                                                      <div class="mail-attatched__item">
                                                         <figure class="mb-0">
                                                            <div class="mail-attatched__image mb-3">
                                                               <img src="img/mail/4.png" alt="attatched Image">
                                                               <div class="mail-attatched__hover">
                                                                  <a href="#" class="btn-mail">
                                                                     <img src="img/svg/download.svg" alt="download" class="svg"></a>
                                                                  <a href="#" class="btn-mail">
                                       ...
                                       <div class="mail-reply">
                                                ...
                                                <div class="mdc__right media-body">
                                                   <div class="mdc__head d-flex justify-content-between">
                                                      ...
                                                      <div class="mdc__excerpt">
                                                         <span class="date-meta">Jan 2, 2020, 5:22 PM</span>
                                                         <a href="#">
                                                            <img src="img/svg/star.svg" alt="star" class="svg"></a>
                                                         <a href="#">
                                                            <img src="img/svg/corner-up-left.svg" alt="corner-up-left" class="svg"></a>
                                                         <a href="#" class="dropdownMenu">
                                                            <img class="svg" src="img/svg/more-vertical.svg" alt="more-vertical"></a>
                                                      </div>
                                                   </div>
                                          ...
                                          <div class="mail-reply__action d-flex">
                                             <a href="#" class="btn btn-outline-lighten btn-md"><img src="img/svg/corner-up-left.svg" alt="corner-up-left" class="svg">Reply</a>
                                             <a href="#" class="btn btn-outline-lighten btn-md"><img class="svg" src="img/svg/corner-up-right.svg" alt="corner-up-right">Forword</a>
                                          </div>
                                          <div class="mail-reply-box media">
                                             <figure>
                                                <img src="img/reply-1.png" alt="Reply Author">
                                             </figure>
                                       ...
                                       <form action="#">
                                          <div class="dm-mailCompose__header d-flex justify-content-between align-items-center">
                                             ...
                                             <div class="dm-mailCompose__action">
                                                <a href="#">
                                                   <img src="img/svg/maximize-2.svg" alt="sliders" class="svg">
                                                </a>
                                                <a class="compose-close" href="#" data-trigger="compose">
                                                   <img src="img/svg/x.svg" alt="x" class="svg"></a>
                                             </div>
                                          </div>
