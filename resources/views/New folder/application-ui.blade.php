                              ...
                              <ul>
                                 ...
                                 <li class="has-subMenu-left">
                                    ...
                                    <ul class="subMenu">
                                       ...
                                       <li>
                                          <a href="application-ui.html" class="active">Project Details</a>
                                       </li>
                                       <li>
                  ...
                  <div class="breadcrumb-main application-ui mb-30">
                     <div class="breadcrumb-action d-flex">
                        ...
                        <div class="action-btn me-10 my-sm-0">
                           <a href="#" class="btn btn-primary bg-primary fs-12 fw-500"><img src="img/svg/plus.svg" alt="plus" class="svg"> Add
                              task</a>
                        </div>
                     ...
                     <div class="card">
                        <div class="card-header p-0">
                           <ul class="nav px-25 ap-tab-main app-ui-tab" id="project-ap-tab" role="tablist">
                              <li class="nav-item">
                                 <a class="nav-link active" id="project-overview-tab" data-bs-toggle="pill" href="#project-overview" role="tab" aria-selected="true">task list</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" id="project-timeline-tab" data-bs-toggle="pill" href="#project-timeline" role="tab" aria-selected="false">Activities</a>
                              </li>
                           </ul>
                        </div>
                                 ...
                                 <div class="project-task table-responsive table-responsive--dynamic">
                                       ...
                                       <tbody>
                                             ...
                                             <td>
                                                <div class="checkbox-group d-flex">
                                                   <div class="checkbox-theme-default custom-checkbox checkbox-group__single d-flex">
                                                      <input class="checkbox" type="checkbox" id="check-grp-taske1" checked>
                                                      <label for="check-grp-taske1" class="fs-14 color-light strikethrough">
                                          ...
                                          <tr class="project-task-list ptl--hover draggable " draggable="true">
                                             <td>
                                                <div class="checkbox-group d-flex">
                                                   <div class="checkbox-theme-default custom-checkbox checkbox-group__single d-flex">
                                                      <input class="checkbox" type="checkbox" id="check-grp-taske2" checked>
                                                      <label for="check-grp-taske2" class="fs-14 color-light strikethrough">
                                          ...
                                          <tr class="project-task-list ptl--hover draggable " draggable="true">
                                             <td>
                                                <div class="checkbox-group d-flex">
                                                   <div class="checkbox-theme-default custom-checkbox checkbox-group__single d-flex">
                                                      <input class="checkbox" type="checkbox" id="check-grp-taske3">
                                                      <label for="check-grp-taske3" class="fs-14 color-light strikethrough">
                                          ...
                                          <tr class="project-task-list ptl--hover draggable " draggable="true">
                                             <td>
                                                <div class="checkbox-group d-flex">
                                                   <div class="checkbox-theme-default custom-checkbox checkbox-group__single d-flex">
                                                      <input class="checkbox" type="checkbox" id="check-grp-taske4">
                                                      <label for="check-grp-taske4" class="fs-14 color-light strikethrough">
                                          ...
                                          <tr class="project-task-list ptl--hover draggable " draggable="true">
                                             <td>
                                                <div class="checkbox-group d-flex">
                                                   <div class="checkbox-theme-default custom-checkbox checkbox-group__single d-flex">
                                                      <input class="checkbox" type="checkbox" id="check-grp-taske5">
                                                      <label for="check-grp-taske5" class="fs-14 color-light strikethrough">
                                    ...
                                    <div class="task-list-btn px-25 my-10">
                                       <button class="text-primary">
                                          <img class="svg" src="img/svg/plus.svg" alt="">Add New
                                          Task</button>
                                    </div>
                                 </div>
                              </div>
                                                   ...
                                                   <div class="d-flex">
                                                      <div class="me-3 ffp__imgWrapper d-flex align-items-center ">
                                                         <span class=" wh-24 me-15 rounded-circle content-center color-danger bg-opacity-danger">
                                                            <img src="img/svg/plus.svg" alt="plus" class="svg"></span>
                                                   ...
                                                   <div class="d-flex">
                                                      <div class="me-3 ffp__imgWrapper d-flex align-items-center ">
                                                         <span class=" wh-24 me-15 rounded-circle content-center color-primary bg-opacity-primary">
                                                            <img src="img/svg/code.svg" alt="code" class="svg"></span>
                                                   ...
                                                   <div class="d-flex">
                                                      <div class="me-3 ffp__imgWrapper d-flex align-items-center ">
                                                         <span class=" wh-24 me-15 rounded-circle content-center color-success bg-opacity-success">
                                                            <img src="img/svg/check.svg" alt="check" class="svg"></span>
                                                   ...
                                                   <div class="d-flex">
                                                      <div class="me-3 ffp__imgWrapper d-flex align-items-center ">
                                                         <span class=" wh-24 me-15 rounded-circle content-center color-info bg-opacity-info">
                                                            <img src="img/svg/user-plus.svg" alt="user-plus" class="svg"></span>
                                                         <span class="profile-image rounded-circle d-block wh-34 m-0 " style="background-image:url('img/tm2.png'); background-size: cover;"></span>
                                                      </div>
                                                      <div>
                                                         <a href="#">
                                                ...
                                                <div class="ffp d-flex justify-content-between align-items-center w-100">
                                                   <div class="d-flex">
                                                      <div class="me-3 ffp__imgWrapper d-flex align-items-center ">
                                                         <span class=" wh-24 me-15 rounded-circle content-center color-primary bg-opacity-primary">
                                                            <img src="img/svg/code.svg" alt="code" class="svg"></span>
                                                         <span class="profile-image rounded-circle d-block wh-34 m-0 " style="background-image:url('img/tm3.png'); background-size: cover;"></span>
                                                      </div>
                                                      <div>
                                                         <a href="#">
                                                            <p class="fw-500 fs-14 text-dark mb-0">Mike Greene
                                                   ...
                                                   <div class="d-flex">
                                                      <div class="me-3 ffp__imgWrapper d-flex align-items-center ">
                                                         <span class=" wh-24 me-15 rounded-circle content-center color-warning bg-opacity-warning">
                                                            <img src="img/svg/upload.svg" alt="upload" class="svg"></span>
                                                         <span class="profile-image rounded-circle d-block wh-34 m-0 " style="background-image:url('img/tm4.png'); background-size: cover;"></span>
                                                      </div>
                                                      <div>
                                                         <a href="#">
                                                            <p class="fw-500 fs-14 text-dark mb-0">Tomlinson
