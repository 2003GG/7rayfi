    ...
    <form action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="px-5 mb-4">
        <label class="block text-[10px] font-dm font-semibold text-[#7a7870] uppercase tracking-widest mb-1.5">
          Title <span class="text-gold">*</span>
        </label>
      ...
      <div class="px-5 mb-4">
        <label class="block text-[10px] font-dm font-semibold text-[#7a7870] uppercase tracking-widest mb-1.5">
          Content <span class="text-gold">*</span>
        </label>
      ...
      <div class="px-5 mb-4">
        ...
        <input type="text" name="tags"
          placeholder="e.g. Laravel, Remote, OpenToWork"
      ...
      <div class="px-5 mb-5">
        ...
        {{-- Pickers (hidden after selection) --}}
        <div id="media-pickers" class="flex gap-3">
        ...
        {{-- Preview area (shown after file chosen) --}}
        <div id="media-preview" class="hidden mt-3 relative rounded-xl overflow-hidden border border-white/[0.06]">
          ...
          <div class="flex items-center justify-between px-3 py-2 bg-[#1a1d24] border-t border-white/[0.06]">
            ...
            <button type="button" onclick="clearMedia()"
              class="text-[11px] text-red-400 hover:text-red-300 transition-colors font-dm">
              ✕ Remove
            </button>
          </div>
        </div>
