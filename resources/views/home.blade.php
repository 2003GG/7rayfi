...
<body class="min-h-screen flex items-center justify-center gradient-bg p-4">
    <div class="w-full max-w-6xl grid md:grid-cols-2 gap-8 items-center">
        ...
        <div class="text-white space-y-6 slide-in hidden md:block">
            <div class="flex items-center gap-3 mb-8">
                <div class="w-12 h-12 bg-gradient-to-br from-purple-500 to-blue-500 rounded-lg flex items-center justify-center shadow-lg glow-effect">
    ...
    <script>
        ...
        document.getElementById('signupForm').addEventListener('submit', function(e) {
            ...
            // Validation
            if (!firstName || !lastName || !email || !password || !country || !terms) {
            ...
            setTimeout(() => {
                ...
                // In a real application, you would redirect to the profile setup or home page
            }, 2000);
        });
    </script>
</body>
