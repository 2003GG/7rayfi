    ...
    <div class="flex gap-5 items-start">
      ...
      <div class="flex-1 min-w-0">
        ...
        <div class="flex items-center justify-between gap-3 bg-surface border border-white/[0.06] rounded-2xl px-5 py-4 mb-5">
          <div>
            ...
            <p class="font-syne font-bold text-2xl text-[#e8e6e0]">12 <span class="text-gold">jobs</span></p>
          </div>
        ...
        <div class="job-card group job-card-group bg-surface border border-white/[0.06] rounded-2xl p-5 mb-3 hover:border-gold/40 hover:shadow-gold-sm transition-all duration-300 cursor-pointer">
          <div class="job-card-inner rounded-xl">
            <div class="flex items-start justify-between gap-3 mb-3">
              <div class="flex items-start gap-3">
                <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-gold/20 to-gold/5 border border-gold/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span class="font-syne font-bold text-gold text-sm">7H</span>
                </div>
                <div>
                  <div class="flex items-center gap-1.5 mb-1">
                    <svg class="w-3 h-3 text-[#7a7870]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
                    <span class="text-[11px] text-[#7a7870]">{{ $offer->location }}</span>
                  </div>
                  <h2 class="font-syne font-bold text-[17px] text-[#e8e6e0] leading-snug">{{ $offer->title }}</h2>
                  <p class="text-[13px] text-[#9ca3af] mt-0.5">7erayfi · Tech · Product</p>
                </div>
              </div>
              <span class="inline-flex items-center gap-1.5 text-[11px] font-dm font-700 bg-amber-500/10 text-amber-400 border border-amber-500/25 px-2.5 py-1 rounded-full whitespace-nowrap flex-shrink-0">
        ...
        <div class="job-card group job-card-group bg-surface border border-white/[0.06] rounded-2xl p-5 mb-3 hover:border-gold/40 hover:shadow-gold-sm transition-all duration-300 cursor-pointer">
          <div class="job-card-inner rounded-xl">
            <div class="flex items-start justify-between gap-3 mb-3">
              <div class="flex items-start gap-3">
                <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500/15 to-indigo-500/5 border border-indigo-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <h2 class="font-syne font-bold text-[17px] text-[#e8e6e0] leading-snug">Product Designer</h2>
                  <p class="text-[13px] text-[#9ca3af] mt-0.5">Atlas Labs · Design · UX</p>
                </div>
              </div>
              <span class="text-[11px] font-dm font-700 bg-emerald-500/10 text-emerald-400 border border-emerald-500/25 px-2.5 py-1 rounded-full whitespace-nowrap flex-shrink-0">Full-time</span>
            </div>
            <p class="text-sm text-[#94a3b8] leading-relaxed mb-3">Lead product discovery and deliver beautiful interfaces for enterprise products used across the MENA region.</p>
            <div class="flex items-center justify-between gap-3">
              <div class="flex gap-1.5 flex-wrap">
                <span class="text-[11px] border border-gold/30 text-gold/80 bg-gold/5 px-2.5 py-1 rounded-full">Figma</span>
                <span class="text-[11px] border border-gold/30 text-gold/80 bg-gold/5 px-2.5 py-1 rounded-full">User Research</span>
                <span class="text-[11px] border border-gold/30 text-gold/80 bg-gold/5 px-2.5 py-1 rounded-full">SaaS</span>
              </div>
      ...
      <aside class="w-[240px] flex-shrink-0 sticky top-[68px]">
        ...
        <div class="bg-gradient-to-br from-gold/10 to-transparent border border-gold/20 rounded-2xl p-4 mb-4">
          <div class="flex items-center gap-2 mb-2">
            <svg class="w-4 h-4 text-gold" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/></svg>
            <span class="font-syne font-bold text-sm text-gold">Job Alerts</span>
          </div>
          <p class="text-[12px] text-[#7a7870] mb-3 leading-relaxed">Get notified when new jobs match your search.</p>
          <button class="w-full btn-gold font-dm font-semibold text-ink text-xs py-2 rounded-lg">Enable alerts</button>
        </div>
        ...
        <div class="bg-surface border border-white/[0.06] rounded-2xl p-4">
          ...
          <div class="space-y-4">
            <div>
              ...
              <div class="relative">
                <svg class="absolute left-2.5 top-1/2 -translate-y-1/2 w-3 h-3 text-[#7a7870]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
                <input class="w-full bg-surface2 border border-white/[0.07] rounded-lg pl-7 pr-3 py-2 text-xs text-[#e8e6e0] transition-colors" placeholder="All locations" />
              </div>
            </div>

            <div>
              <span class="filter-label">Function</span>
              <input class="w-full bg-surface2 border border-white/[0.07] rounded-lg px-3 py-2 text-xs text-[#e8e6e0] transition-colors" placeholder="Any role" />
            </div>
