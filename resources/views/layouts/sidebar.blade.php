            ...
            <div class="card">
                ...
                <div class="prof-banner">
                    <div class="prof-inner">
                        ...
                        <p
                            style="font-family:'Cormorant Garamond',serif;font-size:17px;font-weight:600;color:#fff;text-align:center;line-height:1.2;">
                            {{ auth()->user()->name }}
                        </p>
                ...
                <div style="padding:4px 8px 10px;">
                    ...
                    <a href="#" class="snav active">
                        <span class="ic"><svg width="13" height="13" viewBox="0 0 24 24" fill="none"
                                stroke="var(--saffron)" stroke-width="2">
                    ...
                    <a href="{{ route('user.singout') }}" class="snav"
                        ...
                        <span class="ic"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#e05555"
                                stroke-width="2">
